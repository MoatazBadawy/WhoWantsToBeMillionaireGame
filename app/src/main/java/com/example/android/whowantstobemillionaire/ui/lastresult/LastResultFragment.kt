...
class LastResultFragment : BaseFragment<FragmentLastResultBinding>(R.layout.fragment_last_result) {
    ...
    override fun onCreateView() {
        ...
        binding.startBtn.setOnClickListener {v ->
            Navigation.findNavController(v).navigate(R.id.action_lastResultFragment_to_questionFragment)
        }
    }
